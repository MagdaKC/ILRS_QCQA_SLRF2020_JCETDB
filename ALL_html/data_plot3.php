...
$title1="ORIGIN OFFSETS wrt SLRF2008 AC($analysis_center) CC($combination_center) ";
...
if ($_POST[PLOTS2]=="Rxyz")
{$tab = "$_POST[combination_center]_info_$_POST[analysis_center]";
$title1="EULER ROTATIONS wrt SLRF2008 AC($analysis_center) CC($combination_center) ";
$type="Rotation [mas]";
$plota="Rx";
$plotaa="RX";
$plotb="Ry";
