...
<div id="dialog" class="ui-dialog1"  > Mean/Std. Dev.:  <?php echo $avg3 ?> &#177; <?php echo $std3 ?> Count: <?php echo $num3 ?>  </div>
<div id="report"</div>
</td>
<td>
...
<script type="text/javascript">
   ...
   w.document.write('<html><head><title> <?php echo $title1 ?> EVALUATION OF WEEKLY AWG PRODUCTS </title></head><body>' +  printOn3) + '</body></html>';
   w.document.write('<br>')
   w.document.write('<br>')
   w.document.write('<br>')
   w.document.write('<br>')
