...
//echo "A".$PLOTS2."B".$_POST[analysis_center];
//echo $y_min.'<br/><br/>';
//echo $y_max.'<br/><br/>';
//echo $var0.'<br/><br/>';
//echo $var1.'<br/><br/>';
...
//echo AA.$station_name.'<br/><br/>';
//echo AA.$combination_center.'<br/><br/>';
    if ($_POST['start_date']=="" or $_POST['end_date']=="" or $_POST['station_name']=="")
        { $tmp="";
            foreach ( $_POST as $ind=>$val )
            if($val == "" || !isset($val)) {
if ($ind=="start_date" )
{ echo "<br><br><br><br><br><br><br><br><br><center><font color='red' size='24'>Please select the start  time from the sidebar</font>".'<br/><br/>';}
if ($ind=="end_date")
{ echo "<br><br><br><br><br><br><br><br><br><center><font color='red' size='24'>Please select the end time from the sidebar</font>".'<br/><br/>';}
 } else
            {
            $graphlink= $graphlink.$tmp.$ind."=".$val;
           $graphlink1= $graphlink1.$tmp.$ind."=".$val;
              $tmp="&";
              }}



elseif ($_POST['PLOTS1']=="COS2")
...
{
     include "data_plot4N_D_A4_T.php";
...
{
     include "data_plot4N_D_A6_T.php";
...
{
     include "data_plot4N_D_A7_T.php";
...
//include "data_plot3.php";
//	echo "data_plot3.php";
include "data_plot3N_D_T.php";
}
elseif ($_POST['var0']=="yes" and $_POST['var1']=="yes" and $_POST['var2']=="")
{
	//include "data_plot3.php";
	include "data_plot3N2_D_T.php";
}
elseif ($_POST['var0']=="yes" and $_POST['var1']=="" and $_POST['var2']=="yes")
{
	    //include "data_plot3.php";
	    include "data_plot3N3_D_T.php";
}
elseif ($_POST['var0']=="" and $_POST['var1']=="yes" and $_POST['var2']=="yes")
{
	        //include "data_plot3.php";
	        include "data_plot3N4_D_T.php";
}

elseif ($_POST['var0']=="yes" and $_POST['var1']=="" and $_POST['var2']=="")
{
	        //include "data_plot3.php";
	        include "data_plot3N5_D_T.php";
}

elseif ($_POST['var0']=="" and $_POST['var1']=="yes" and $_POST['var2']=="")
{
	        //include "data_plot3.php";
	        include "data_plot3N6_D_T.php";
}

elseif ($_POST['var0']=="" and $_POST['var1']=="" and $_POST['var2']=="yes")
{
	        //include "data_plot3.php";
	        include "data_plot3N7_D_T.php";
}



}
//echo $_POST[PLOTS2]=="Rxyz";
