    ...
    function initialize_variable_b()
    {
        ...
        for (i=0; i<secondGroups; i++)
            ...
            secondGroup[1][40]=new  Option( "7359  Daedeok", "7359 Daedeok")
            secondGroup[1][41]=new  Option( "7357  Beijing-A", "7357 Beijing-A")
            secondGroup[1][42]=new  Option( "7358  Tanegashima", "7358 Tanegashima")
            secondGroup[1][43]=new  Option( "7370  Burnie", "7370 Burnie")
            secondGroup[1][44]=new  Option( "7394  Sejong", "7394 Sejong")
            secondGroup[1][45]=new  Option( "7403  Arequipa", "7403 Arequipa")
            secondGroup[1][46]=new  Option( "7405  Concepcion", "7405 Concepcion")
            secondGroup[1][47]=new  Option( "7406  San Juan", "7406 San Juan")
            secondGroup[1][48]=new  Option( "7407  Brasilia", "7407 Brasilia")
            secondGroup[1][49]=new  Option( "7410  Algonqui", "7410 Algonqui")
            secondGroup[1][50]=new  Option( "7411  La_Grand", "7411 La_Grand")
            secondGroup[1][51]=new  Option( "7501  Hartebeestho", "7501 Hartebeestho")
            secondGroup[1][52]=new  Option( "7502  Sutherla", "7502 Sutherla")
            secondGroup[1][53]=new  Option( "7520  Karitsa", "7520 Karitsa")
            secondGroup[1][54]=new  Option( "7548  Cagliari", "7548 Cagliari")
            secondGroup[1][55]=new  Option( "7549  TIGO", "7549 TIGO")
            secondGroup[1][56]=new  Option( "7597  Wettzell", "7597 Wettzell")
            secondGroup[1][57]=new  Option( "7604  Brest", "7604 Brest")
            secondGroup[1][58]=new  Option( "7806  Metsahovi", "7806 Metsahovi")
            secondGroup[1][59]=new  Option( "7810  Zimmerwald", "7810 Zimmerwald")
            secondGroup[1][60]=new  Option( "7811  Borowiec", "7811 Borowiec")
            secondGroup[1][61]=new  Option( "7820  Kunming", "7820 Kunming")
            secondGroup[1][62]=new  Option( "7821  Shanghai", "7821 Shanghai")
            secondGroup[1][63]=new  Option( "7822  Papeete", "7822 Papeete")
            secondGroup[1][64]=new  Option( "7823  San-Fernand", "7823 San-Fernand")
            secondGroup[1][65]=new  Option( "7824  San-Fernand", "7824 San-Fernand")
            secondGroup[1][66]=new  Option( "7825  Mt-Stromlo", "7825 Mt-Stromlo")
            secondGroup[1][67]=new  Option( "7826  Mt-Stromlo", "7826 Mt-Stromlo")
            secondGroup[1][68]=new  Option( "7827  SOSW", "7827 SOSW")
            secondGroup[1][69]=new  Option( "7830  Chania", "7830 Chania")
            secondGroup[1][70]=new  Option( "7831  Helwan", "7831 Helwan")
            secondGroup[1][71]=new  Option( "7832  Riyadh", "7832 Riyadh")
            secondGroup[1][72]=new  Option( "7835  Grasse", "7835 Grasse")
            secondGroup[1][73]=new  Option( "7836  Potsdam", "7836 Potsdam")
            secondGroup[1][74]=new  Option( "7837  Shanghai", "7837 Shanghai")
            secondGroup[1][75]=new  Option( "7838  Simosato", "7838 Simosato")
            secondGroup[1][76]=new  Option( "7839  Graz", "7839 Graz")
            secondGroup[1][77]=new  Option( "7840  Herstmonceux", "7840 Herstmonceux")
            secondGroup[1][78]=new  Option( "7841  Potsdam", "7841 Potsdam")
            secondGroup[1][79]=new  Option( "7843  Orroral" , "7843 Orroral")
            secondGroup[1][80]=new  Option( "7845  Grasse", "7845 Grasse")
            secondGroup[1][81]=new  Option( "7846  Grasse", "7846 Grasse")
            secondGroup[1][82]=new  Option( "7847  Yarragad", "7847 Yarragad")
            secondGroup[1][83]=new  Option( "7848  Ajaccio", "7848 Ajaccio")
            secondGroup[1][84]=new  Option( "7849  Mt.Stromlo", "7849 Mt.Stromlo")
            secondGroup[1][85]=new  Option( "7850  Mcdonald", "7850 Mcdonald")
            secondGroup[1][86]=new  Option( "7864  Stafford", "7864 Stafford")
            secondGroup[1][87]=new  Option( "7865  Stafford", "7865 Stafford")
            secondGroup[1][88]=new  Option( "7882  Cabo_San", "7882 Cabo_San")
            secondGroup[1][89]=new  Option( "7883  Ensenada", "7883 Ensenada")
            secondGroup[1][90]=new  Option( "7918  Greenbelt" , "7918 Greenbelt")
            secondGroup[1][91]=new  Option( "7939  Matera", "7939 Matera")
            secondGroup[1][92]=new  Option( "7941  Matera", "7941 Matera")
            secondGroup[1][93]=new  Option( "8834  Wettzell", "8834 Wettzell")
    }
