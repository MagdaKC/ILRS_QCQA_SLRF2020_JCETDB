...
yAxis: {labels: { style: { color: '#000000', fontSize: '16px' },align:'right', x:15,formatter: function () {return this.value;} },endOnTick: false, startOnTick: false,
 title: { text: '<?php echo $plotccc ?> <?php echo $type ?>', style: { color: '#000000', fontSize: '16px' },margin: 25 }, min: <?php echo $y_min ?> , max: <?php echo $y_max ?>},
...
<div class="contentToPrint">
    <div id="container1" style="border: 2px solid #2E4C3D;width: 1000px; height: 720px"></div>
</div> </div>
