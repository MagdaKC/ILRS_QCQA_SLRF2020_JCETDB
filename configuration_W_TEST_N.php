...
<script type="text/javascript" src="common_W_T.js"></script>
<body>
<!--<table width="100%" height="80%" cellpadding="2" cellspacing="0" class="tbmain">-->
<table width="600" height="50%" cellpadding="2" cellspacing="0" class="tbmain">
<tr>
<td class="midleft" width="10">&nbsp;&nbsp;&nbsp;</td>
<td class="midmid" valign="top">
<form  target="_blank" action="generateresults_W.php"  method="post" name="isc" id="frm1" >
...
<table width="100%" cellpadding="5" cellspacing="0">
 <tr align="center" style="vertical-align: top; text-align: center; width: 53px;">
  ...
  <font size="4" color=#006600><CENTER>7-day arc weekly solution (one solution/week)</CENTER></font>
...
<option value=eop>EOP</option></select>
 ...
 <tr >
  ...
  <td class="right">
   <select style="width:200px;margin:5px 0 5px 0;" class="other" onchange=redirect_b(this.options.selectedIndex) name="PLOTS2" id="PLOTS2" >
