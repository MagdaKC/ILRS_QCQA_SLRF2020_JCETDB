...
{ $queryS1 = "SELECT distinct STDDEV ($plota *1000 ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and solution=$solution and $plota is not NULL ;";
  $queryS2 = "SELECT distinct STDDEV ($plotb *1000 ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and solution=$solution and $plotb is not NULL ;";
  $queryS3 = "SELECT distinct STDDEV ($plotc *1000 ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and solution=$solution and $plotc is not NULL ;";}
else
//"eop, Txyz, Rxyz")
...
{ $queryS1 = "SELECT distinct STDDEV ($plota  ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and solution=$solution and $plota is not NULL ;";
 $queryS2 = "SELECT distinct STDDEV ($plotb  ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and solution=$solution and $plotb is not NULL ;";
 $queryS3 = "SELECT distinct STDDEV ($plotc  ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and solution=$solution and $plotc is not NULL ;";}
else
//"eop, Txyz, Rxyz")
...
{ if ($_POST[PLOTS2]=="eop" )
{$conn_string = "host=jcetdb.rs.umbc.edu port=5432 dbname=ilrsa_d_slrf2020 password=Ichinen user=jasongroup  connect_timeout=2";
$query1 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime1, $plota as value1, $splota as value4 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plota  < $limita1 and $plota > $limitb1 and solution=$solution and $plota is not NULL  ORDER BY observation_date ;";
$query2 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime2, $plotb as value2, $splotb as value5 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plotb  < $limita2 and $plotb > $limitb2 and solution=$solution and $plotb is not NULL  ORDER BY observation_date;";
$query3 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime3, $plotc as value3, $splotc as value6 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plotc  < $limita3 and $plotc > $limitb3 and solution=$solution and $plotc is not NULL  ORDER BY observation_date;";}}
