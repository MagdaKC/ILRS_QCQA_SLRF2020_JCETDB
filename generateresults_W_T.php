 ...
 <LINK REL="SHORTCUT ICON" HREF="JCET.ico">
  <link rel="stylesheet" href="css/butt.css" type="text/css" />
    <script>
	  function open_win()
{
	    window.open("configuration_WD.php", "_blank", "width=500px,height=600px");
}
</script>
  <script>
    function open_winH()
{
	    window.open("http://geodesy.jcet.umbc.edu/ILRS_AWG_MONITORING/", "_blank");
}
</script>
<?php
...
//The PLOT 1 works with conditions
 if ($_POST[combination_center]=="ilrsa" and $_POST[PLOTS2]=="vce")
...
if ($_POST[PLOTS2]=="number_of_stations" or $_POST[PLOTS2]=="obs" or  $_POST[PLOTS2]=="unk" or  $_POST[PLOTS2]=="wssoc" or  $_POST[PLOTS2]=="vf"  or $_POST[PLOTS2]=="drwrms"  or  $_POST[PLOTS2]=="vce" )
{if ($_POST[analysis_center]!="com")
{ include "data_plot1N_T.php"; }
else
{ $answer="NO INFORMATION AVAILABLE IN DATA BASE";
echo "<br><br><br><br><br><br><br><br><br><center><font color='red' size='24'>$answer </font>".'<br/><br/>'; }}
...
//{echo "data_plot4N_ALL4.php";
//include "data_plot4N_ALL4.php";}
...
else
{
     ...
     include "$station_numberBDH";
     include "$station_numberBDD";
     include "data_plot4N_C2.php";
     //include "$station_numberC";
     //include "$station_numberCDH";
     //include "$station_numberCDD";
     include "data_plot4N_D2.php";
}}
...
//include "data_plot3N.php";
     ...
     include "$station_numberADH";
     include "$station_numberADD";
     include "data_plot4N_B3.php";
     //include "$station_numberB";
     //include "$station_numberBDH";
     //include "$station_numberBDD";
     include "data_plot4N_C3.php";
     include "$station_numberC";
     include "$station_numberCDH";
     include "$station_numberCDD";
     include "data_plot4N_D3.php";
}}
...
{
     include "data_plot4N_A4_T.php";
     //include "$station_numberA";
     //include "$station_numberADH";
     //include "$station_numberADD";
     include "data_plot4N_B4.php";
     include "$station_numberB";
     include "$station_numberBDH";
     include "$station_numberBDD";
     include "data_plot4N_C.php";
...
else
{
     ...
     include "$station_numberADH";
     include "$station_numberADD";
     include "data_plot4N_B5.php";
     include "data_plot4N_D5.php";
}}
...
{
     include "data_plot4N_A6_T.php";
     include "data_plot4N_B6.php";
     include "$station_numberB";
     include "$station_numberBDH";
     include "$station_numberBDD";
     include "data_plot4N_C6.php";
     include "data_plot4N_D6.php";
}}
...
{
     include "data_plot4N_A7_T.php";
     include "data_plot4N_C7.php";
     include "$station_numberC";
     include "$station_numberCDH";
     include "$station_numberCDD";
     include "data_plot4N_D7.php";
}}
...
{
//include "data_plot3.php";
include "data_plot3N_T.php";
}
elseif ($_POST['var0']=="yes" and $_POST['var1']=="yes" and $_POST['var2']=="")
{
	//include "data_plot3.php";
	include "data_plot3N2_T.php";
}
elseif ($_POST['var0']=="yes" and $_POST['var1']=="" and $_POST['var2']=="yes")
{
	    //include "data_plot3.php";
	    include "data_plot3N3_T.php";
}
elseif ($_POST['var0']=="" and $_POST['var1']=="yes" and $_POST['var2']=="yes")
{
	        //include "data_plot3.php";
	        include "data_plot3N4_T.php";
}

elseif ($_POST['var0']=="yes" and $_POST['var1']=="" and $_POST['var2']=="")
{
	        //include "data_plot3.php";
	        include "data_plot3N5_T.php";
}

elseif ($_POST['var0']=="" and $_POST['var1']=="yes" and $_POST['var2']=="")
{
	        //include "data_plot3.php";
	        include "data_plot3N6_T.php";
}

elseif ($_POST['var0']=="" and $_POST['var1']=="" and $_POST['var2']=="yes")
{
	        //include "data_plot3.php";
	        include "data_plot3N7_T.php";
}
