...
(function (H) {
    ...
    function _exponential(data) {
        ...
        var string = 'exponential ' + 'y = ' + Math.round(A*100) / 100 + 'e^(' + Math.round(B*100) / 100 + 'x)';
...
var GG = gradient.toExponential(2);
        var string = 'linear'+  '<br/> '+ 'y = ' + GG + 'x + ' + intercept.toExponential(2);
    ...
    function _logarithmic(data) {
        ...
        var string = 'logarithmic \n' + ' y = ' + Math.round(A*100) / 100 + ' + ' + Math.round(B*100) / 100 + ' ln(x)';
...
var GG = gradient.toExponential(2);
        ...
        var string = 'power'+  'y = ' + GG + 'x^' + Math.round(B*100) / 100;
...
//        }
        ...
        for(var i = equation.length-1; i >= 0; i--){
var GG = equation[i].toExponential(2);
            if(i > 1) string += GG + 'x^' + i + ' + ';
            else if (i == 1) string += GG + 'x' + ' + ';
            else string += GG / 100;
        }
