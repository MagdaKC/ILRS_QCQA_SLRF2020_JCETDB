...
secondGroup[1][10]=new  Option( "1879  Altay", "1879 Altay")
    ...
    secondGroup[1][12]=new  Option( "1887  Baikonur", "1887 Baikonur")
    secondGroup[1][13]=new  Option( "1888  Svetloe", "1888 Svetloe")
    secondGroup[1][14]=new  Option( "1889  Zelenchuks", "1889 Zelenchuks")
    secondGroup[1][15]=new  Option( "1890  Badary", "1890 Badary")
    secondGroup[1][16]=new  Option( "1893  Katzively", "1893 Katzively")
 secondGroup[1][17]=new  Option( "7040  Wrightwood", "7040 Wrightwood")
    secondGroup[1][18]=new  Option( "7080  McDonald-Obs", "7080 McDonald-Obs")
    secondGroup[1][19]=new  Option( "7090  Yarragadee", "7090 Yarragadee")
    secondGroup[1][20]=new  Option( "7105  Greenbelt", "7105 Greenbelt")
    secondGroup[1][21]=new  Option( "7110  Monument-Pea", "7110 Monument-Pea")
    secondGroup[1][22]=new  Option( "7119  Haleakala", "7119 Haleakala")
    secondGroup[1][23]=new  Option( "7124  Tahiti", "7124 Tahiti")
    secondGroup[1][24]=new  Option( "7210  Haleakala", "7210 Haleakala")
    secondGroup[1][25]=new  Option( "7231  Wuhan", "7231 Wuhan")
    secondGroup[1][26]=new  Option( "7236  Wuhan", "7236 Wuhan")
    secondGroup[1][27]=new  Option( "7237  Changchun", "7237 Changchun")
    secondGroup[1][28]=new  Option( "7249  Beijing", "7249 Beijing")
    secondGroup[1][29]=new  Option( "7308  Koganei", "7308 Koganei")
    secondGroup[1][30]=new  Option( "7328  Koganei", "7328 Koganei")
    secondGroup[1][31]=new  Option( "7335  Kashima", "7335 Kashima")
    secondGroup[1][32]=new  Option( "7337  Miura", "7337 Miura")
    secondGroup[1][33]=new  Option( "7339  Tateyama", "7339 Tateyama")
    secondGroup[1][34]=new  Option( "7343  Beiji", "7343 Beiji")
    secondGroup[1][35]=new  Option( "7355  Urumqi", "7335 Urumqi")
    secondGroup[1][36]=new  Option( "7356  Lhasa", "7356 Lhasa")
    secondGroup[1][37]=new  Option( "7357  Beijing-A", "7357 Beijing-A")
    secondGroup[1][38]=new  Option( "7358  Tanegashima", "7358 Tanegashima")
    secondGroup[1][39]=new  Option( "7370  Burnie", "7370 Burnie")
    secondGroup[1][40]=new  Option( "7403  Arequipa", "7403 Arequipa")
    secondGroup[1][41]=new  Option( "7405  Concepcion", "7405 Concepcion")
    secondGroup[1][42]=new  Option( "7406  San Juan", "7406 San Juan")
    secondGroup[1][43]=new  Option( "7501  Hartebeestho", "7501 Hartebeestho")
    secondGroup[1][44]=new  Option( "7548  Cagliari", "7548 Cagliari")
    secondGroup[1][45]=new  Option( "7549  TIGO", "7549 TIGO")
    secondGroup[1][46]=new  Option( "7604  Brest", "7604 Brest")
    secondGroup[1][47]=new  Option( "7806  Metsahovi", "7806 Metsahovi")
    secondGroup[1][48]=new  Option( "7810  Zimmerwald", "7810 Zimmerwald")
    secondGroup[1][49]=new  Option( "7811  Borowiec", "7811 Borowiec")
   secondGroup[1][50]=new  Option( "7820  Kunming", "7820 Kunming")
    secondGroup[1][51]=new  Option( "7821  Shanghai", "7821 Shanghai")
    secondGroup[1][52]=new  Option( "7822  Papeete", "7822 Papeete")
    secondGroup[1][53]=new  Option( "7823  San-Fernand", "7823 San-Fernand")
    secondGroup[1][54]=new  Option( "7824  San-Fernand", "7824 San-Fernand")
    secondGroup[1][55]=new  Option( "7825  Mt-Stromlo", "7825 Mt-Stromlo")
    secondGroup[1][56]=new  Option( "7826  Mt-Stromlo", "7826 Mt-Stromlo")
    secondGroup[1][57]=new  Option( "7830  Chania", "7830 Chania")
    secondGroup[1][58]=new  Option( "7831  Helwan", "7831 Helwan")
    secondGroup[1][59]=new  Option( "7832  Riyadh", "7832 Riyadh")
    secondGroup[1][60]=new  Option( "7835  Grasse", "7835 Grasse")
    secondGroup[1][61]=new  Option( "7836  Potsdam", "7836 Potsdam")
    secondGroup[1][62]=new  Option( "7837  Shanghai", "7837 Shanghai")
    secondGroup[1][63]=new  Option( "7838  Simosato", "7838 Simosato")
    secondGroup[1][64]=new  Option( "7839  Graz", "7839 Graz")
    secondGroup[1][65]=new  Option( "7840  Herstmonceux", "7840 Herstmonceux")
    secondGroup[1][66]=new  Option( "7841  Potsdam", "7841 Potsdam")
    secondGroup[1][67]=new  Option( "7843  Orroral" , "7843 Orroral")
    secondGroup[1][68]=new  Option( "7845  Grasse", "7845 Grasse")
    secondGroup[1][69]=new  Option( "7846  Grasse", "7846 Grasse")
    secondGroup[1][70]=new  Option( "7848  Ajaccio", "7848 Ajaccio")
    secondGroup[1][71]=new  Option( "7849  Mt.Stromlo", "7849 Mt.Stromlo")
    secondGroup[1][72]=new  Option( "7864  Stafford", "7864 Stafford")
    secondGroup[1][73]=new  Option( "7865  Stafford", "7865 Stafford")
    secondGroup[1][74]=new  Option( "7918  Greenbelt" , "7918 Greenbelt")
    secondGroup[1][75]=new  Option( "7939  Matera", "7939 Matera")
    secondGroup[1][76]=new  Option( "7941  Matera", "7941 Matera")
    secondGroup[1][77]=new  Option( "8834  Wettzell", "8834 Wettzell")
    ...
    additional_data_left["XYZ"][3]= "<input type=\"checkbox\"  name=\"var3\" class=\"other\" value=\"yes\" /><label class=\"left\">STATION EVENTS</label>";
    additional_data_left["XYZ"][4]= "<input type=\"checkbox\"  name=\"var4\" class=\"other\" value=\"yes\" /><label class=\"left\">Linear Regression/label>";
    ...
    additional_data_left["NEU"][3]= "<input type=\"checkbox\"  name=\"var3\" class=\"other\" value=\"yes\" /><label class=\"left\">STATION EVENTS</label>";
