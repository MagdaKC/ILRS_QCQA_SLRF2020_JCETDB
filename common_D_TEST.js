      ...
      function initialize_variables_a() {
        ...
        group[4][1]=new Option("ORIGIN OFFSETS w.r.t SLRF2020","Txyz");
        group[4][2]=new Option("SCALE w.r.t SLRF2020","Scale");
        group[4][3]=new Option("EULER ROTATIONS w.r.t SLRF2020", "Rxyz");
        group[4][4]=new Option("GLOBAL WRMS w.r.t. SLRF2020", "GRMS");
        group[4][5]=new Option("CORE WRMS w.r.t. SLRF2020","CRMS");
    ...
    function initialize_variable_b()
    {
        ...
        for (i=0; i<secondGroups; i++)
            ...
            secondGroup[1][17]=new  Option( "1891  Irkutsk", "1891 Irkutsk")
            secondGroup[1][18]=new  Option( "1893  Katzively", "1893 Katzively")
            secondGroup[1][19]=new  Option( "1953  Santiago", "1953 Santiago")
            secondGroup[1][20]=new  Option( "7080  McDonald-Obs", "7080 McDonald-Obs")
            secondGroup[1][21]=new  Option( "7090  Yarragadee", "7090 Yarragadee")
            secondGroup[1][22]=new  Option( "7105  Greenbelt", "7105 Greenbelt")
            secondGroup[1][23]=new  Option( "7110  Monument-Pea", "7110 Monument-Pea")
            secondGroup[1][24]=new  Option( "7119  Haleakala", "7119 Haleakala")
            secondGroup[1][25]=new  Option( "7122  Mazatlan", "7122 Mazatlan")
            secondGroup[1][26]=new  Option( "7124  Tahiti", "7124 Tahiti")
            secondGroup[1][27]=new  Option( "7210  Haleakala", "7210 Haleakala")
            secondGroup[1][28]=new  Option( "7231  Wuhan2", "7231 Wuhan2")
            secondGroup[1][29]=new  Option( "7236  Wuhan1", "7236 Wuhan1")
            secondGroup[1][30]=new  Option( "7237  Changchun", "7237 Changchun")
            secondGroup[1][31]=new  Option( "7249  Beijing", "7249 Beijing")
            secondGroup[1][32]=new  Option( "7295  Richmond", "7295 Richmond")
            secondGroup[1][33]=new  Option( "7306  Tsukuba", "7306 Tsukuba")
            secondGroup[1][34]=new  Option( "7308  Koganei", "7308 Koganei")
            secondGroup[1][35]=new  Option( "7328  Koganei", "7328 Koganei")
            secondGroup[1][36]=new  Option( "7335  Kashima", "7335 Kashima")
            secondGroup[1][37]=new  Option( "7337  Miura", "7337 Miura")
            secondGroup[1][38]=new  Option( "7339  Tateyama", "7339 Tateyama")
            secondGroup[1][39]=new  Option( "7343  Beiji", "7343 Beiji")
            secondGroup[1][40]=new  Option( "7355  Urumqi", "7355 Urumqi")
            secondGroup[1][41]=new  Option( "7356  Lhasa", "7356 Lhasa")
            secondGroup[1][42]=new  Option( "7359  Daedeok", "7359 Daedeok")
            secondGroup[1][43]=new  Option( "7357  Beijing-A", "7357 Beijing-A")
            secondGroup[1][44]=new  Option( "7358  Tanegashima", "7358 Tanegashima")
            secondGroup[1][45]=new  Option( "7370  Burnie", "7370 Burnie")
            secondGroup[1][46]=new  Option( "7394  Sejong", "7394 Sejong")
            secondGroup[1][47]=new  Option( "7395  Geochang", "7395 Geochang")
            secondGroup[1][48]=new  Option( "7396  Wuhan3", "7396 Wuhan3")
            secondGroup[1][49]=new  Option( "7403  Arequipa", "7403 Arequipa")
            secondGroup[1][50]=new  Option( "7405  Concepcion", "7405 Concepcion")
            secondGroup[1][51]=new  Option( "7406  San_Juan", "7406 San_Juan")
            secondGroup[1][52]=new  Option( "7407  Brasilia", "7407 Brasilia")
            secondGroup[1][53]=new  Option( "7410  Algonqui", "7410 Algonqui")
            secondGroup[1][54]=new  Option( "7411  La_Grand", "7411 La_Grand")
            secondGroup[1][55]=new  Option( "7501  HartRAONASA", "7501 HartRAONASA")
            secondGroup[1][56]=new  Option( "7502  Sutherla", "7502 Sutherla")
            secondGroup[1][57]=new  Option( "7503  HartRAORussia", "7503 HartRAORussia")
            secondGroup[1][58]=new  Option( "7520  Karitsa", "7520 Karitsa")
            secondGroup[1][59]=new  Option( "7548  Cagliari", "7548 Cagliari")
            secondGroup[1][60]=new  Option( "7549  TIGO", "7549 TIGO")
            secondGroup[1][61]=new  Option( "7597  Wettzell", "7597 Wettzell")
            secondGroup[1][62]=new  Option( "7604  Brest", "7604 Brest")
            secondGroup[1][63]=new  Option( "7701  Izana", "7701 Izana")
            secondGroup[1][64]=new  Option( "7806  Metsahovi", "7806 Metsahovi")
            secondGroup[1][65]=new  Option( "7807  Metsahovi3", "7807 Metsahovi3")
            secondGroup[1][66]=new  Option( "7810  Zimmerwald", "7810 Zimmerwald")
            secondGroup[1][67]=new  Option( "7811  Borowiec", "7811 Borowiec")
            secondGroup[1][68]=new  Option( "7816  Stuttgart", "7816 Stuttgart")
            secondGroup[1][69]=new  Option( "7817  Yebes", "7817 Yebes")
            secondGroup[1][70]=new  Option( "7819  Kunming", "7819 Kunming")
            secondGroup[1][71]=new  Option( "7820  Kunming", "7820 Kunming")
            secondGroup[1][72]=new  Option( "7821  Shanghai", "7821 Shanghai")
            secondGroup[1][73]=new  Option( "7822  Papeete", "7822 Papeete")
            secondGroup[1][74]=new  Option( "7823  San-Fernand", "7823 San-Fernand")
            secondGroup[1][75]=new  Option( "7824  San-Fernand", "7824 San-Fernand")
            secondGroup[1][76]=new  Option( "7825  Mt-Stromlo2", "7825 Mt-Stromlo2")
            secondGroup[1][77]=new  Option( "7826  Mt-Stromlo", "7826 Mt-Stromlo")
            secondGroup[1][78]=new  Option( "7827  SOSW", "7827 SOSW")
            secondGroup[1][79]=new  Option( "7830  Chania", "7830 Chania")
            secondGroup[1][80]=new  Option( "7831  Helwan", "7831 Helwan")
            secondGroup[1][81]=new  Option( "7832  Riyadh", "7832 Riyadh")
            secondGroup[1][82]=new  Option( "7835  Grasse", "7835 Grasse")
            secondGroup[1][83]=new  Option( "7836  Potsdam2", "7836 Potsdam2")
            secondGroup[1][84]=new  Option( "7837  Shanghai", "7837 Shanghai")
            secondGroup[1][85]=new  Option( "7838  Simosato", "7838 Simosato")
            secondGroup[1][86]=new  Option( "7839  Graz", "7839 Graz")
            secondGroup[1][87]=new  Option( "7840  Herstmonceux", "7840 Herstmonceux")
            secondGroup[1][88]=new  Option( "7841  Potsdam", "7841 Potsdam")
            secondGroup[1][89]=new  Option( "7843  Orroral", "7843 Orroral")
            secondGroup[1][90]=new  Option( "7845  GrasseMeO", "7845 GrasseMeO")
            secondGroup[1][91]=new  Option( "7846  Grasse", "7846 Grasse")
            secondGroup[1][92]=new  Option( "7847  Yarragad", "7847 Yarragad")
            secondGroup[1][93]=new  Option( "7848  Ajaccio", "7848 Ajaccio")
            secondGroup[1][94]=new  Option( "7849  Mt.Stromlo1", "7849 Mt.Stromlo1")
            secondGroup[1][95]=new  Option( "7850  Mcdonald", "7850 Mcdonald")
            secondGroup[1][96]=new  Option( "7864  Stafford", "7864 Stafford")
            secondGroup[1][97]=new  Option( "7865  Stafford", "7865 Stafford")
            secondGroup[1][98]=new  Option( "7882  Cabo_San", "7882 Cabo_San")
            secondGroup[1][99]=new  Option( "7883  Ensenada", "7883 Ensenada")
            secondGroup[1][100]=new  Option( "7918  Greenbelt", "7918 Greenbelt")
            secondGroup[1][101]=new  Option( "7939  MateraSAO", "7939 MateraSAO")
            secondGroup[1][102]=new  Option( "7941  Matera", "7941 Matera")
            secondGroup[1][103]=new  Option( "8834  Wettzell", "8834 Wettzell")
    }
...
//    additional_data_left["XYZ"][3]= "<input type=\"checkbox\"  name=\"var4\" class=\"other\" value=\"yes\" /><label class=\"left\">REGRESSION</label>";
    additional_data_left["XYZ"][3]= "<input type=\"checkbox\"  name=\"var3\" class=\"other\" value=\"yes\" /><label class=\"left\">STATIONS EVENT</label>";
 ...
 //   additional_data_left["NEU"][3]= "<input type=\"checkbox\"  name=\"var4\" class=\"other\" value=\"yes\" /><label class=\"left\">REGRESSION</label>";
    additional_data_left["NEU"][3]= "<input type=\"checkbox\"  name=\"var3\" class=\"other\" value=\"yes\" /><label class=\"left\">STATIONS EVENT</label>";
  ...
  //  additional_data_left["Txyz"][3]= "<input type=\"checkbox\"  name=\"var4\" class=\"other\" value=\"yes\" /><label class=\"left\">REGRESSION</label>";
   ...
   // additional_data_left["Helmert_Txyz_COM"][3]= "<input type=\"checkbox\"  name=\"var4\" class=\"other\" value=\"yes\" /><label class=\"left\">REGRESSION</label>";
...
// Marker shape Filled square, then Filled Diamond and then Filled Circle.
      ...
      if(typeof(additional_data_left2[plot_name])!="undefined"){
          ...
          //for(i=0; i<additional_data_left[plot_name].length; i++) {
          for(i=0; i<1; i++) {
              var ni = document.getElementById('myDivleft');
              var num = 1;
              var newdiv = document.createElement('div');
...
if(plot_name=="XYZ" || plot_name=="NEU"){
          for(i=3; i<4; i++) {
              ...
              newdiv.innerHTML =  additional_data_left[plot_name][i]  +"<br><br><br><br>" ;
              ni.appendChild(newdiv);
