...
tooltip: {
            formatter: function() {
                var s = '<b>'+ Highcharts.dateFormat('%A, %b %e, %Y', this.x) +'</b>' + '<br/> '+ '<?php echo $plotccc ?> <?php echo $typeL ?>  '  + this.y + '<br/> ';
...
yAxis: {labels: { style: { color: '#000000', fontSize: '16px' },align:'right', x:15,formatter: function () {return this.value;} },endOnTick: false, startOnTick: false,
 title: { text: '<?php echo $plotccc ?> <?php echo $typeL ?>', style: { color: '#000000', fontSize: '16px' },margin: 25 }, min: <?php echo $y_min ?> , max: <?php echo $y_max ?>},
...
series : [
{<?php echo $REG11 ?> <?php echo $REG22 ?> <?php echo $REG33 ?> <?php echo $REG44 ?> <?php echo $REG55 ?> dataGrouping: { enabled: false },lineWidth : 0, name: '<?php echo $plotccc ?>  <?php echo $station_name ?>' , showInLegend: true, marker: {enabled : true, symbol: '<?php echo $marktype2 ?>',<?php echo $mm ?> }, color: '<?php echo $color2 ?>', data: [<?php echo join($data5, ',') ?>] },
...
<script type="text/javascript">
   ...
   w.document.write('<html><head><title> <?php echo $title1 ?> php echo $title1 ?> EVALUATION OF WEEKLY AWG PRODUCTS </title></head><body>' + printOne + '' + printOn2 + '' + printOn3) + '</body></html>';
   w.document.write('<br>')
   w.document.write('<br>')
   w.document.write('<br>')
   w.document.write('<br>')
