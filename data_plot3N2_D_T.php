...
// $report.html( 'avgX: ' + dataX.value / dataX.count);
       ...
       xAxis : {labels: { style: { color: '#000000', fontSize: '14px' } },
                gridLineWidth: 1,
ordinal: false,
                type : 'datetime',
title: { text: 'DATE',style: { color: '#000000', fontSize: '14px' } },
...
yAxis: {labels: { style: { color: '#000000', fontSize: '14px' },align:'right', x:15,formatter: function () {return this.value;} },endOnTick: false, startOnTick: false,
 title: { text: '<?php echo $plotaaa ?> <?php echo $type ?>',style: { color: '#000000', fontSize: '14px' },margin: 25 }, min: <?php echo $y_min ?> , max: <?php echo $y_max ?>},
legend: {
enabled: true,
                layout: 'vertical',
                align: 'left',
...
yAxis: {labels: { style: { color: '#000000', fontSize: '14px' } },endOnTick: false, startOnTick: false,
 title: { text: '<?php echo $plotbbb ?> <?php echo $type ?>', style: { color: '#000000', fontSize: '14px' } }, min: <?php echo $y_min ?> , max: <?php echo $y_max ?>},
	   legend: {
enabled: true,
		                 layout: 'vertical',
						                 align: 'left',
