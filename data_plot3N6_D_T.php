...
<div id="dialog" class="ui-dialog1"> Mean/Std. Dev.:  <?php echo $avg2 ?> &#177; <?php echo $std2 ?> Count: <?php echo $num2 ?>  </div> </div>
</td>
<td>
...
<script type="text/javascript">
   ...
   w.document.write('<html><head><title> <?php echo $title1 ?> EVALUATION OF WEEKLY AWG PRODUCTS </title></head><body>' + printOn2 ) + '</body></html>';
   w.document.write('<br>')
   w.document.write('<br>')
   w.document.write('<br>')
   w.document.write('<br>')
