...
//    additional_data_left["NEU"][8]= "<input type=\"checkbox\"  name=\"var3\" class=\"other\" value=\"yes\" /><label class=\"left\">STATIONS EVENT</label>";
    ...
    additional_data_left["Txyz"][3]= "<input type=\"checkbox\"  name=\"var3\" class=\"other\" value=\"yes\" /><label class=\"left\"></label>";
...
//      color_template_right51 = "<select class \"right\" name=\"COL";
      ...
      mark_template_left =  "<table><tr><td class=\"left\"><label class=\"left\">Select Marktype test:</label></td>";
...
//          alert(plot_name+" : " + additional_data_left[plot_name].length);
//      if(plot_name=="XYZ"){
 //         alert(plot_name);}
//else
//{ alert(plot_name+" : " + additional_data_left[plot_name].length)+ color_template_right5;}
