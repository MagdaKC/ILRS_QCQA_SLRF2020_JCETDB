...
series : [
{<?php echo $REG11 ?> <?php echo $REG22 ?> <?php echo $REG33 ?> <?php echo $REG44 ?> <?php echo $REG55 ?> dataGrouping: { enabled: false },lineWidth : 0, name: '<?php echo $plotaaa ?>  <?php echo $station_name ?>' , showInLegend: true, marker: {enabled : true, symbol: '<?php echo $marktype0 ?>',<?php echo $mm ?> }, color: '<?php echo $color0 ?>', data: [<?php echo join($data1, ',') ?>] },
