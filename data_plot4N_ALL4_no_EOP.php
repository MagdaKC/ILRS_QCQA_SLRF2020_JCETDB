...
$LegendZ="false";
if ($_POST[combination_center]=="ilrsa")
{$conn_string = "host=jcetdb.rs.umbc.edu port=5432 dbname=ilrsa_slrf2020 password=Ichinen user=jasongroup  connect_timeout=2";}
if ($_POST[combination_center]=="ilrsb")
{$conn_string = "host=jcetdb.rs.umbc.edu port=5432 dbname=ilrsb_slrf2020 password=Ichinen user=jasongroup  connect_timeout=2";}
...
$query2 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime2, $plotb as value2, $splotb as value5 from $tab where observation_date > '$start_date' and observation_date < '$end_date' and station_id='$station_nameN' and $plota  < $limita2 and $plota > $limitb2  ORDER BY observation_date;";
$query3 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime3, $plotc as value3, $splotc as value6 from $tab where observation_date > '$start_date' and observation_date < '$end_date' and station_id='$station_nameN' and $plota  < $limita3 and $plota > $limitb3 ORDER BY observation_date;";}
//echo $query1;
...
$query2 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime2, $plotb *1000 as value2, $splotb *1000 as value5 from $tab where observation_date > '$start_date' and observation_date < '$end_date' and station_id='$station_nameN' and $plota *1000 < $limita2 and $plota *1000> $limitb2 ORDER BY observation_date;";
$query3 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime3, $plotc *1000 as value3, $splotc *1000 as value6 from $tab where observation_date > '$start_date' and observation_date < '$end_date' and station_id='$station_nameN' and $plota *1000 < $limita3 and $plota *1000> $limitb3 ORDER BY observation_date;";}
...
{//$conn_string = "host=jcetdb.rs.umbc.edu port=5432 dbname=ilrsa password=Ichinen user=jasongroup  connect_timeout=2";
...
$query2 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime2, $plotb as value2, $splotb as value5 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plota  < $limita2 and $plota > $limitb2 ORDER BY observation_date;";
$query3 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime3, $plotc as value3, $splotc as value6 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plota  < $limita3 and $plota > $limitb3 ORDER BY observation_date;";}}
...
{//$conn_string = "host=jcetdb.rs.umbc.edu port=5432 dbname=ilrsb password=Ichinen user=jasongroup  connect_timeout=2";
...
$query2 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime2, $plotb *1000 as value2, $splotb *1000 as value5 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plota *1000 < $limita2 and $plota *1000> $limitb2   ORDER BY observation_date;";
$query3 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime3, $plotc *1000 as value3, $splotc *1000 as value6 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plota *1000 < $limita3 and $plota *1000> $limitb3   ORDER BY observation_date;";}}
...
$query2 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime2, $plotb as value2 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plota  < $limita2 and $plota > $limitb2 ORDER BY observation_date;";
$query3 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime3, $plotc as value3 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plota  < $limita3 and $plota > $limitb3 ORDER BY observation_date;";}
...
$query2 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime2, $plotb *1000 as value2 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plota *1000 < $limita2 and $plota *1000> $limitb2 ORDER BY observation_date;";
$query3 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime3, $plotc *1000 as value3 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plota *1000 < $limita3 and $plota *1000> $limitb3 ORDER BY observation_date;";}
...
html += "<span>Mean/Std. Dev.: " + MEAN + "</span>" + " &plusmn; " + STD2 + " </span>"+ "Count:" +  dataY.count + " </span><br />";
            $("#dialog1").html(html == "" ? "No results" : html);
...
yAxis: {labels: { style: { color: '#000000', fontSize: '9px' },align:'right', x:15,formatter: function () {return this.value;} },endOnTick: false, startOnTick: false,
 title: { text: '<?php echo $plotaaa ?> <?php echo $type ?>',style: { color: '#000000', fontSize: '10px' },margin: 25 }, min: <?php echo $y_min ?> , max: <?php echo $y_max ?>},
legend: {
enabled: true,
                layout: 'vertical',
                align: 'left',
...
yAxis: {labels: { style: { color: '#000000', fontSize: '9px' },align:'right', x:15,formatter: function () {return this.value;}},endOnTick: false, startOnTick: false,
 title: { text: '<?php echo $plotbbb ?> <?php echo $type ?>', style: { color: '#000000', fontSize: '10px' },margin: 25 }, min: <?php echo $y_min ?> , max: <?php echo $y_max ?>},
...
<div id="dialog1" class="ui-dialog1"> Mean/Std. Dev.:  <?php echo $avg1 ?> &#177; <?php echo $std1 ?> Count: <?php echo $num1 ?>  </div>
<table>
<tr>
<td>
<div id="report"</div>
...
<button id="opener1" class="Web_OnlineTools2">Statistics</button>
...
<td style="vertical-align: top; text-align: left; width: 53px;">
<button id="opener3" class="Web_OnlineTools">Statistics</button>
</td>
...
//X
if ($_POST['var0']=="yes")
{$query = "SELECT observation_date as datetime1, to_char($plota *$MN , '999999D999')  as value1 from $tab where observation_date > '$start_date' and observation_date < '$end_date' and solution=$solution ORDER BY observation_date ;";}
//Y
if ($_POST['var1']=="yes")
{$query = "SELECT observation_date as datetime1,  to_char($plotb *$MN , '999999D999') as value2 from $tab where observation_date > '$start_date' and observation_date < '$end_date' and solution=$solution ORDER BY observation_date ;";}
//Z
if ($_POST['var2']=="yes")
{$query = "SELECT observation_date as datetime1, to_char($plotc *$MN , '999999D999') as value3 from $tab where observation_date > '$start_date' and observation_date < '$end_date' and solution=$solution ORDER BY observation_date ;";}
//XY
if ($_POST['var0']=="yes" and $_POST['var1']=="yes")
{$query = "SELECT observation_date as datetime1, to_char($plota *$MN , '999999D999')  as value1, to_char($plotb *$MN , '999999D999') as value2 from $tab where observation_date > '$start_date' and observation_date < '$end_date' and solution=$solution ORDER BY observation_date ;";}
//XZ
if ($_POST['var0']=="yes" and $_POST['var2']=="yes")
{$query = "SELECT observation_date as datetime1, to_char($plota *$MN , '999999D999')  as value1, to_char($plotc *$MN , '999999D999') as value3 from $tab where observation_date > '$start_date' and observation_date < '$end_date' and solution=$solution  ORDER BY observation_date;";}
//YZ
if ($_POST['var1']=="yes" and $_POST['var2']=="yes")
{$query = "SELECT observation_date as datetime1, to_char($plotb *$MN , '999999D999') as value2, to_char($plotc *$MN , '999999D999') as value3 from $tab where observation_date > '$start_date' and observation_date < '$end_date' and solution=$solution  ORDER BY observation_date;";}
////XYZ
if ($_POST['var0']=="yes" and $_POST['var1']=="yes" and $_POST['var2']=="yes")
{$query = "SELECT observation_date as datetime1, to_char($plota *$MN , '999999D999')  as value1, to_char($plotb *$MN , '999999D999') as value2, to_char($plotc *$MN , '999999D999') as value3 from $tab where observation_date > '$start_date' and observation_date < '$end_date' and solution=$solution ORDER BY observation_date ;";}
}
//echo $query.'<br/><br/>';
