...
series : [
{<?php echo $REG11 ?> <?php echo $REG22 ?> <?php echo $REG33 ?> <?php echo $REG44 ?> <?php echo $REG55 ?> dataGrouping: { enabled: false },lineWidth : 0, name: '<?php echo $plotaaa ?>  <?php echo $station_name ?>' , showInLegend: true, false: {enabled : true, symbol: '<?php echo $marktype1 ?>',<?php echo $mm ?> }, color: '<?php echo $color1 ?>', data: [<?php echo join($data3, ',') ?>] },
