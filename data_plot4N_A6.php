...
//"eop, Txyz, Rxyz")
{ $queryS1 = "SELECT distinct STDDEV ($plota *1000 ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and $plota is not NULL ;";
 $queryS2 = "SELECT distinct STDDEV ($plotb *1000 ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and $plotb is not NULL ;";
 $queryS3 = "SELECT distinct STDDEV ($plotc *1000 ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and $plotc is not NULL ;";}}
...
//"eop, Txyz, Rxyz")
{ $queryS1 = "SELECT distinct STDDEV ($plota  ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and $plota is not NULL ;";
 $queryS2 = "SELECT distinct STDDEV ($plotb  ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and $plotb is not NULL ;";
 $queryS3 = "SELECT distinct STDDEV ($plotc  ) from $tab where observation_date >= '$start_date' and observation_date < '$end_date' and $plotc is not NULL ;";}}
//echo $queryS1.'<br/>';
//echo $queryS2.'<br/>';
//echo $queryS3.'<br/>';
...
{$conn_string = "host=jcetdb.rs.umbc.edu port=5432 dbname=ilrsa_slrf2020 user=jasongroup  password=Ichinen  connect_timeout=2";
$query1 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime1, $plota as value1, $splota as value4 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plota  < $limita1 and $plota > $limitb1 and $plota is not NULL  ORDER BY observation_date;";
$query2 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime2, $plotb as value2, $splotb as value5 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plotb  < $limita2 and $plotb > $limitb2 and $plotb is not NULL ORDER BY observation_date;";
$query3 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime3, COALESCE($plotc,0) as value3, $splotc as value6 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plotc  < $limita3 and $plotc > $limitb3 and $plotc is not NULL ORDER BY observation_date;";}
//echo $query1;
}
...
$query1 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime1, $plota *1000 as value1, $splota *1000 as value4 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plota *1000 < $limita1 and $plota *1000> $limitb1 and $plota is not NULL   ORDER BY observation_date;";
$query2 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime2, $plotb *1000 as value2, $splotb *1000 as value5 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plotb *1000 < $limita2 and $plotb *1000> $limitb2 and $plotb is not NULL   ORDER BY observation_date;";
$query3 = "SELECT EXTRACT(EPOCH from observation_date at time zone 'utc-00') *1000 as datetime3, $plotc *1000 as value3, $splotc *1000 as value6 from $tab where observation_date > '$start_date' and observation_date < '$end_date'  and $plotc *1000 < $limita3 and $plotc *1000> $limitb3   and $plotc is not NULL ORDER BY observation_date;";}}
...
{if ($_POST[combination_center]=="ilrsa")
{$queryS = "SELECT distinct AVG ($plota)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plota  < $limita1 and $plota > $limitb1 and $plota is not NULL ;";}
if ($_POST[combination_center]=="ilrsb")
{$queryS = "SELECT distinct AVG ($plota *1000)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plota *1000  < $limita1 and $plota *1000 > $limitb1 and $plota is not NULL ;";}}
//echo $queryS.'<br/><br/>';
...
if ($_POST[PLOTS2]=="eop" or $_POST[PLOTS2]=="eopSTD" or $_POST[PLOTS2]=="eopmean" or $_POST[PLOTS2]=="Txyz" or $_POST[PLOTS2]=="Helmert_Txyz_COM" or $_POST[PLOTS2]=="Rxyz" or $_POST[PLOTS2]=="Helmert_Rxyz_COM"  )
{if ($_POST[combination_center]=="ilrsa")
{$queryS = "SELECT count ($plota)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plota  < $limita1 and $plota > $limitb1 and $plota is not NULL ;";}
if ($_POST[combination_center]=="ilrsb")
{$queryS = "SELECT count ($plota *1000)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plota *1000  < $limita1 and $plota *1000 > $limitb1 and $plota is not NULL ;";}}
//echo $queryS.'<br/><br/>';
$resultS = pg_query($queryS) or die("" );
...
if ($_POST[PLOTS2]=="eop" or $_POST[PLOTS2]=="eopSTD" or $_POST[PLOTS2]=="eopmean" or $_POST[PLOTS2]=="Txyz" or $_POST[PLOTS2]=="Helmert_Txyz_COM" or $_POST[PLOTS2]=="Rxyz" or $_POST[PLOTS2]=="Helmert_Rxyz_COM"  )
{if ($_POST[combination_center]=="ilrsa")
{$queryS = "SELECT distinct STDDEV ($plota)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plota  < $limita1 and $plota > $limitb1 and $plota is not NULL ;";}
if ($_POST[combination_center]=="ilrsb")
{$queryS = "SELECT distinct STDDEV ($plota *1000)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plota *1000  < $limita1 and $plota *1000 > $limitb1 and $plota is not NULL ;";}}
...
if ($_POST[PLOTS2]=="eop" or $_POST[PLOTS2]=="eopSTD" or $_POST[PLOTS2]=="eopmean" or $_POST[PLOTS2]=="Txyz" or $_POST[PLOTS2]=="Helmert_Txyz_COM" or $_POST[PLOTS2]=="Rxyz" or $_POST[PLOTS2]=="Helmert_Rxyz_COM"  )
{if ($_POST[combination_center]=="ilrsa")
{$queryS = "SELECT distinct AVG ($plotb)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotb  < $limita2 and $plotb > $limitb2 and $plotb is not NULL ;";}
if ($_POST[combination_center]=="ilrsb")
{$queryS = "SELECT distinct AVG ($plotb *1000)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotb *1000  < $limita2 and $plotb *1000 > $limitb2 and $plotb is not NULL ;";}}
$resultS = pg_query($queryS) or die("" );
$avg = pg_fetch_array($resultS, 0, PGSQL_NUM);
...
if ($_POST[PLOTS2]=="XYZ" or $_POST[PLOTS2]=="NEU")
{if ($_POST[combination_center]=="ilrsb")
    { $queryS = "SELECT count ($plotb *$MN)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date' and station_id='$station_nameN'  and $plotb *$MN  < $limita2 and $plotb *$MN > $limitb2;";}


if ($_POST[combination_center]=="ilrsa")
{$queryS = "SELECT count ($plotb)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date' and station_id='$station_nameN'  and $plotb  < $limita2 and $plotb > $limitb2;";}}
if ($_POST[PLOTS2]=="eop" or $_POST[PLOTS2]=="eopSTD" or $_POST[PLOTS2]=="eopmean" or $_POST[PLOTS2]=="Txyz" or $_POST[PLOTS2]=="Helmert_Txyz_COM" or $_POST[PLOTS2]=="Rxyz" or $_POST[PLOTS2]=="Helmert_Rxyz_COM"  )
{if ($_POST[combination_center]=="ilrsa")
{$queryS = "SELECT count ($plotb)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotb  < $limita2 and $plotb > $limitb2 and $plotb is not NULL ;";}
if ($_POST[combination_center]=="ilrsb")
{$queryS = "SELECT count ($plotb *1000)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotb *1000  < $limita2 and $plotb *1000 > $limitb2 and $plotb is not NULL ;";}}
//echo $queryS.'<br/><br/>';
$resultS = pg_query($queryS) or die("" );
$num = pg_fetch_array($resultS, 0, PGSQL_NUM);
...
if ($_POST[PLOTS2]=="eop" or $_POST[PLOTS2]=="eopSTD" or $_POST[PLOTS2]=="eopmean" or $_POST[PLOTS2]=="Txyz" or $_POST[PLOTS2]=="Helmert_Txyz_COM" or $_POST[PLOTS2]=="Rxyz" or $_POST[PLOTS2]=="Helmert_Rxyz_COM"  )
{if ($_POST[combination_center]=="ilrsa")
{$queryS = "SELECT distinct STDDEV ($plotb)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotb  < $limita2 and $plotb > $limitb2 and $plotb is not NULL ;";}
if ($_POST[combination_center]=="ilrsb")
{$queryS = "SELECT distinct STDDEV ($plotb *1000)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotb *1000  < $limita2 and $plotb *1000 > $limitb2 and $plotb is not NULL ;";}}
...
if ($_POST[PLOTS2]=="eop" or $_POST[PLOTS2]=="eopSTD" or $_POST[PLOTS2]=="eopmean" or $_POST[PLOTS2]=="Txyz" or $_POST[PLOTS2]=="Helmert_Txyz_COM" or $_POST[PLOTS2]=="Rxyz" or $_POST[PLOTS2]=="Helmert_Rxyz_COM"  )
{if ($_POST[combination_center]=="ilrsa")
{$queryS = "SELECT distinct AVG ($plotc)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotc  < $limita3 and $plotc > $limitb3 and $plotc is not NULL ;";}
if ($_POST[combination_center]=="ilrsb")
{$queryS = "SELECT distinct AVG ($plotc *1000)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotc *1000  < $limita3 and $plotc *1000 > $limitb3 and $plotc is not NULL ;";}}
$resultS = pg_query($queryS) or die("" );
$avg = pg_fetch_array($resultS, 0, PGSQL_NUM);
...
if ($_POST[PLOTS2]=="eop" or $_POST[PLOTS2]=="eopSTD" or $_POST[PLOTS2]=="eopmean" or $_POST[PLOTS2]=="Txyz" or $_POST[PLOTS2]=="Helmert_Txyz_COM" or $_POST[PLOTS2]=="Rxyz" or $_POST[PLOTS2]=="Helmert_Rxyz_COM"  )
{if ($_POST[combination_center]=="ilrsa")
{$queryS = "SELECT count  ($plotc)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotc  < $limita3 and $plotc > $limitb3 and $plotc is not NULL ;";}
if ($_POST[combination_center]=="ilrsb")
{$queryS = "SELECT count  ($plotc *1000)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotc *1000  < $limita3 and $plotc *1000 > $limitb3 and $plotc is not NULL ;";}}
$resultS = pg_query($queryS) or die("" );
$num = pg_fetch_array($resultS, 0, PGSQL_NUM);
...
if ($_POST[PLOTS2]=="eop" or $_POST[PLOTS2]=="eopSTD" or $_POST[PLOTS2]=="eopmean" or $_POST[PLOTS2]=="Txyz" or $_POST[PLOTS2]=="Helmert_Txyz_COM" or $_POST[PLOTS2]=="Rxyz" or $_POST[PLOTS2]=="Helmert_Rxyz_COM"  )
{if ($_POST[combination_center]=="ilrsa")
{$queryS = "SELECT distinct STDDEV ($plotc)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotc  < $limita3 and $plotc > $limitb3 and $plotc is not NULL ;";}
if ($_POST[combination_center]=="ilrsb")
{$queryS = "SELECT distinct STDDEV ($plotc *1000)  from $tab where  observation_date > '$start_date' and observation_date < '$end_date'  and $plotc *1000  < $limita3 and $plotc *1000 > $limitb3 and $plotc is not NULL ;";}}
//echo $query2.'<br/><br/>';
//echo $query3.'<br/><br/>';
